...
const CaseTab = () => {
  const { asyncState, filtered, filters, options, viewMode, sort, setSort, setViewMode, setFilters, toggleArrayFilter, resetFilters, handleSelect, handleFinalize, isSubmitting, selectedId } = useCaseTab();
